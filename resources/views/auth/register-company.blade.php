...
<div class="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-2xl">
    ...
    @if ($errors->any())
        <div class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg mb-6">
            <div class="flex items-center mb-2">
                ...
                <span class="font-semibold">Correggi gli errori seguenti:</span>
            </div>
    ...
    <form action="{{ route('registration.store') }}" method="POST" class="space-y-6">
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <label class="cursor-pointer group">
                    ...
                    <div class="p-5 border-2 border-gray-200 rounded-xl peer-checked:border-blue-500 peer-checked:bg-blue-50 transition-all group-hover:border-gray-300">
                        <div class="flex items-center justify-between mb-2">
                            <span class="font-semibold text-gray-800">Mensile</span>
                            <svg class="w-5 h-5 text-blue-500 opacity-0 peer-checked:opacity-100 transition" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                            </svg>
                        </div>
                        <div class="text-3xl font-bold text-blue-600 mb-1">
                            €29<span class="text-sm font-normal text-gray-500">/mese</span>
                        </div>
                        <p class="text-xs text-gray-600">Fatturazione mensile</p>
                    </div>
                </label>
                ...
                <label class="cursor-pointer group relative">
                    ...
                    <div class="p-5 border-2 border-gray-200 rounded-xl peer-checked:border-blue-500 peer-checked:bg-blue-50 transition-all group-hover:border-gray-300 relative">
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <span class="font-semibold text-gray-800">Annuale</span>
                            <svg class="w-5 h-5 text-blue-500 opacity-0 peer-checked:opacity-100 transition" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                            </svg>
                        </div>
                        <div class="text-3xl font-bold text-blue-600 mb-1">
                            €279<span class="text-sm font-normal text-gray-500">/anno</span>
                        </div>
                        <p class="text-xs text-gray-600">Risparmi €69 all'anno</p>
                    </div>
                </label>
            </div>
        </div>
        ...
        <div class="pt-4">
            <button
                type="submit"
                class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
