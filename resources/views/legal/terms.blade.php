                    ...
                    <section id="intro">
                        ...
                        <div class="text-gray-300 space-y-4 leading-relaxed">
                            <p>
                                ...
                                gestita da Fix-Device S.r.l., con sede legale in Italia, P.IVA [DA INSERIRE] (di seguito "<strong class="text-white">Titolare</strong>").
                            </p>
                            <p>
                    ...
                    <section id="legge">
                        ...
                        <div class="text-gray-300 space-y-4 leading-relaxed">
                            <p>
                                ...
                                sarà competente in via esclusiva il Foro di [CITTÀ DA INSERIRE].
                            </p>
                        </div>
                    </section>
                            ...
                            <div class="bg-gray-800 border border-gray-700 rounded-lg p-5 mt-4">
                                ...
                                <ul class="space-y-2 text-sm">
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <span>[INDIRIZZO DA INSERIRE]</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
